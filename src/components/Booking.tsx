...
import { CalendarDays, Users, MapPin, ArrowRight, ArrowLeft, CheckCircle, User, Phone, Mail, MapPinned, Loader2, RefreshCw } from "lucide-react";
...
const Booking = () => {
  ...
  const { locations, loading: locationsLoading, error: locationsError, refresh: refreshLocations } = useLocations();
                      ...
                      <div>
                        ...
                        {locationsError ? (
                          <div className="rounded-md border border-destructive/40 bg-destructive/5 p-3">
                            <p className="text-xs text-destructive font-light mb-2">
                          ...
                          <Select value={location} onValueChange={setLocation}>
                            <SelectTrigger id="location" className="rounded-md text-sm font-light">
                              <SelectValue
                                placeholder={locations.length ? "Select a location" : "No locations available"}
                              />
                            </SelectTrigger>
                            <SelectContent>
                              {locations.map((loc) => (
